...
export const zh: LocaleSpecificConfig<DefaultTheme.Config> = {
  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/zh/06-context-engineering/': [{ text: '第二篇：工具篇', items: [{ text: '第6章 Context Engineering', collapsed: false, items: [{ text: '6.1 Context Engineering 概念', link: '/zh/06-context-engineering/' }, { text: '6.2 AGENTS.md 标准', link: '/zh/06-context-engineering/agents-md' }, { text: '6.3 Rules & Skills 体系', link: '/zh/06-context-engineering/rules-skills' }, { text: '6.4 Claude Skills 构建指南', link: '/zh/06-context-engineering/claude-skills' }, { text: '6.5 Vibe Coding 与 AI-First 开发流', link: '/zh/06-context-engineering/vibe-coding' }, { text: '6.6 Ralph Wiggum 模式', link: '/zh/06-context-engineering/ralph-pattern' }] }] }],
